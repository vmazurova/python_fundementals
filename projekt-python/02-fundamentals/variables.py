...
print("V pořadí typ a adresa:")
print(type(students_count), id(is_published))
print(type(rating), id(is_published))
...
hex_num = 0x1A
decimal_binary = (myself_binary)
print("Toto je číslo v desítkové soustave {}".format(decimal_binary))
bitovy_posun = myself_binary >> 2
print("Bitový posun je: {}".format(bitovy_posun))
result = hex_num + myself_binary
vypis_vysledku= "Binární součin čísla {} a {} je {}".format(bin(hex_num), bin(myself_binary), bin(result))
print(vypis_vysledku)
print("V desítkové je to {}".format(result))
